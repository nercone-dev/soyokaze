...
def test_a_tls_config_carries_its_lists_and_flags():
    config = TLSConfig(ciphers="ECDHE-ECDSA-AES256-GCM-SHA384:ECDHE-ECDSA-CHACHA20-POLY1305", groups="X25519:P-256", signature_algorithms="ecdsa_secp384r1_sha384", prefer_server_ciphers=True, session_tickets=False, early_data=True, certificate_compression=True)
