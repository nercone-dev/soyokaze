...
Library.declare("soyokaze_compression_qvalue", c_float, c_char_p, c_size_t)
...
Library.declare("soyokaze_scan_same", c_bool, c_char_p, c_size_t, c_char_p, c_size_t)
...
Library.declare("soyokaze_string_max_prefix_bits", c_uint8)
